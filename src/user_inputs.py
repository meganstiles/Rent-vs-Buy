def getPurchasePrice(price):
    ...
    price of home you are buying

    Returns:

    price of home, removing symbols,commas, etc.
    '''
...
def getDownPayment(down_payment):
    ...
    amount of down_payment in dollars
...
def getInterestRate(int_rate):
    ...
    interest rate of mortgage (format 5.5%)
